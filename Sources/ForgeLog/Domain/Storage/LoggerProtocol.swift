...
// Single-Error metadata overloads.
public extension LoggerProtocol {
    func debug(
        _ message: String,
...
// Error-array metadata overloads.
public extension LoggerProtocol {
    func debug(
        _ message: String,
...
// Single-Encodable metadata overloads.
public extension LoggerProtocol {
...
// Encodable-array metadata overloads.
public extension LoggerProtocol {
    func debug<T: Encodable>(
        _ message: String,
        metadata values: [T],
